...
func (s *Server) RunAPI(listen string) error {
	...
	e.GET("/xrpc/app.gndr.unspecced.searchPostsSkeleton", s.handleSearchPostsSkeleton)
	e.GET("/xrpc/app.gndr.unspecced.searchActorsSkeleton", s.handleSearchActorsSkeleton)
	s.echo = e
