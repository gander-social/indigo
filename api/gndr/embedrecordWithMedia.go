...
// schema: app.gndr.embed.recordWithMedia
...
func init() {
	util.RegisterType("app.gndr.embed.recordWithMedia#main", &EmbedRecordWithMedia{})
} // EmbedRecordWithMedia is a "main" in the app.gndr.embed.recordWithMedia schema.
// RECORDTYPE: EmbedRecordWithMedia
type EmbedRecordWithMedia struct {
	LexiconTypeID string                      `json:"$type,const=app.gndr.embed.recordWithMedia" cborgen:"$type,const=app.gndr.embed.recordWithMedia"`
...
func (t *EmbedRecordWithMedia_Media) MarshalJSON() ([]byte, error) {
	if t.EmbedImages != nil {
		t.EmbedImages.LexiconTypeID = "app.gndr.embed.images"
		return json.Marshal(t.EmbedImages)
	}
	if t.EmbedVideo != nil {
		t.EmbedVideo.LexiconTypeID = "app.gndr.embed.video"
		return json.Marshal(t.EmbedVideo)
	}
	if t.EmbedExternal != nil {
		t.EmbedExternal.LexiconTypeID = "app.gndr.embed.external"
...
// EmbedRecordWithMedia_View is a "view" in the app.gndr.embed.recordWithMedia schema.
//
// RECORDTYPE: EmbedRecordWithMedia_View
type EmbedRecordWithMedia_View struct {
	LexiconTypeID string                           `json:"$type,const=app.gndr.embed.recordWithMedia#view" cborgen:"$type,const=app.gndr.embed.recordWithMedia#view"`
