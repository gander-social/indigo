...
// schema: app.gndr.unspecced.searchStarterPacksSkeleton
...
// UnspeccedSearchStarterPacksSkeleton_Output is the output of a app.gndr.unspecced.searchStarterPacksSkeleton call.
...
// UnspeccedSearchStarterPacksSkeleton calls the XRPC method "app.gndr.unspecced.searchStarterPacksSkeleton".
//
...
func UnspeccedSearchStarterPacksSkeleton(ctx context.Context, c util.LexClient, cursor string, limit int64, q string, viewer string) (*UnspeccedSearchStarterPacksSkeleton_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.unspecced.searchStarterPacksSkeleton", params, nil, &out); err != nil {
		return nil, err
	}
