...
// FeedDefs_BlockedAuthor is a "blockedAuthor" in the app.gndr.feed.defs schema.
type FeedDefs_BlockedAuthor struct {
	Did    string                 `json:"did" cborgen:"did"`
	Viewer *ActorDefs_ViewerState `json:"viewer,omitempty" cborgen:"viewer,omitempty"`
}

// FeedDefs_BlockedPost is a "blockedPost" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_BlockedPost
type FeedDefs_BlockedPost struct {
	LexiconTypeID string                  `json:"$type,const=app.gndr.feed.defs#blockedPost" cborgen:"$type,const=app.gndr.feed.defs#blockedPost"`
	Author        *FeedDefs_BlockedAuthor `json:"author" cborgen:"author"`
	Blocked       bool                    `json:"blocked" cborgen:"blocked"`
	Uri           string                  `json:"uri" cborgen:"uri"`
}

// FeedDefs_FeedViewPost is a "feedViewPost" in the app.gndr.feed.defs schema.
...
func (t *FeedDefs_FeedViewPost_Reason) MarshalJSON() ([]byte, error) {
	if t.FeedDefs_ReasonRepost != nil {
		t.FeedDefs_ReasonRepost.LexiconTypeID = "app.gndr.feed.defs#reasonRepost"
		return json.Marshal(t.FeedDefs_ReasonRepost)
	}
	if t.FeedDefs_ReasonPin != nil {
		t.FeedDefs_ReasonPin.LexiconTypeID = "app.gndr.feed.defs#reasonPin"
...
// FeedDefs_GeneratorView is a "generatorView" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_GeneratorView
type FeedDefs_GeneratorView struct {
	LexiconTypeID       string                             `json:"$type,const=app.gndr.feed.defs#generatorView" cborgen:"$type,const=app.gndr.feed.defs#generatorView"`
...
// FeedDefs_GeneratorViewerState is a "generatorViewerState" in the app.gndr.feed.defs schema.
type FeedDefs_GeneratorViewerState struct {
	Like *string `json:"like,omitempty" cborgen:"like,omitempty"`
}

// FeedDefs_Interaction is a "interaction" in the app.gndr.feed.defs schema.
...
// FeedDefs_NotFoundPost is a "notFoundPost" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_NotFoundPost
type FeedDefs_NotFoundPost struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.defs#notFoundPost" cborgen:"$type,const=app.gndr.feed.defs#notFoundPost"`
	NotFound      bool   `json:"notFound" cborgen:"notFound"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// FeedDefs_PostView is a "postView" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_PostView
type FeedDefs_PostView struct {
	LexiconTypeID string                             `json:"$type,const=app.gndr.feed.defs#postView" cborgen:"$type,const=app.gndr.feed.defs#postView"`
...
func (t *FeedDefs_PostView_Embed) MarshalJSON() ([]byte, error) {
	if t.EmbedImages_View != nil {
		t.EmbedImages_View.LexiconTypeID = "app.gndr.embed.images#view"
		return json.Marshal(t.EmbedImages_View)
	}
	if t.EmbedVideo_View != nil {
		t.EmbedVideo_View.LexiconTypeID = "app.gndr.embed.video#view"
	...
	if t.EmbedRecord_View != nil {
		t.EmbedRecord_View.LexiconTypeID = "app.gndr.embed.record#view"
		return json.Marshal(t.EmbedRecord_View)
	}
	if t.EmbedRecordWithMedia_View != nil {
		t.EmbedRecordWithMedia_View.LexiconTypeID = "app.gndr.embed.recordWithMedia#view"
...
// FeedDefs_ReasonPin is a "reasonPin" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_ReasonPin
type FeedDefs_ReasonPin struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.defs#reasonPin" cborgen:"$type,const=app.gndr.feed.defs#reasonPin"`
}

// FeedDefs_ReasonRepost is a "reasonRepost" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_ReasonRepost
type FeedDefs_ReasonRepost struct {
	LexiconTypeID string                      `json:"$type,const=app.gndr.feed.defs#reasonRepost" cborgen:"$type,const=app.gndr.feed.defs#reasonRepost"`
...
// FeedDefs_ReplyRef is a "replyRef" in the app.gndr.feed.defs schema.
...
func (t *FeedDefs_ReplyRef_Parent) MarshalJSON() ([]byte, error) {
	if t.FeedDefs_PostView != nil {
		t.FeedDefs_PostView.LexiconTypeID = "app.gndr.feed.defs#postView"
		return json.Marshal(t.FeedDefs_PostView)
	}
	if t.FeedDefs_NotFoundPost != nil {
		t.FeedDefs_NotFoundPost.LexiconTypeID = "app.gndr.feed.defs#notFoundPost"
		return json.Marshal(t.FeedDefs_NotFoundPost)
	}
	if t.FeedDefs_BlockedPost != nil {
		t.FeedDefs_BlockedPost.LexiconTypeID = "app.gndr.feed.defs#blockedPost"
...
// FeedDefs_SkeletonFeedPost is a "skeletonFeedPost" in the app.gndr.feed.defs schema.
...
func (t *FeedDefs_SkeletonFeedPost_Reason) MarshalJSON() ([]byte, error) {
	if t.FeedDefs_SkeletonReasonRepost != nil {
		t.FeedDefs_SkeletonReasonRepost.LexiconTypeID = "app.gndr.feed.defs#skeletonReasonRepost"
		return json.Marshal(t.FeedDefs_SkeletonReasonRepost)
	}
	if t.FeedDefs_SkeletonReasonPin != nil {
		t.FeedDefs_SkeletonReasonPin.LexiconTypeID = "app.gndr.feed.defs#skeletonReasonPin"
...
// FeedDefs_SkeletonReasonPin is a "skeletonReasonPin" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_SkeletonReasonPin
type FeedDefs_SkeletonReasonPin struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.defs#skeletonReasonPin" cborgen:"$type,const=app.gndr.feed.defs#skeletonReasonPin"`
}

// FeedDefs_SkeletonReasonRepost is a "skeletonReasonRepost" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_SkeletonReasonRepost
type FeedDefs_SkeletonReasonRepost struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.defs#skeletonReasonRepost" cborgen:"$type,const=app.gndr.feed.defs#skeletonReasonRepost"`
	Repost        string `json:"repost" cborgen:"repost"`
}

// FeedDefs_ThreadContext is a "threadContext" in the app.gndr.feed.defs schema.
//
...
// FeedDefs_ThreadViewPost is a "threadViewPost" in the app.gndr.feed.defs schema.
//
// RECORDTYPE: FeedDefs_ThreadViewPost
type FeedDefs_ThreadViewPost struct {
	LexiconTypeID string                                  `json:"$type,const=app.gndr.feed.defs#threadViewPost" cborgen:"$type,const=app.gndr.feed.defs#threadViewPost"`
...
func (t *FeedDefs_ThreadViewPost_Parent) MarshalJSON() ([]byte, error) {
	if t.FeedDefs_ThreadViewPost != nil {
		t.FeedDefs_ThreadViewPost.LexiconTypeID = "app.gndr.feed.defs#threadViewPost"
...
func (t *FeedDefs_ThreadViewPost_Parent) UnmarshalJSON(b []byte) error {
	...
	switch typ {
	case "app.gndr.feed.defs#threadViewPost":
...
// FeedDefs_ThreadgateView is a "threadgateView" in the app.gndr.feed.defs schema.
...
// FeedDefs_ViewerState is a "viewerState" in the app.gndr.feed.defs schema.
//
