...
// ActorDefs_AdultContentPref is a "adultContentPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_AdultContentPref
type ActorDefs_AdultContentPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#adultContentPref" cborgen:"$type,const=app.gndr.actor.defs#adultContentPref"`
	Enabled       bool   `json:"enabled" cborgen:"enabled"`
}

// ActorDefs_GndrAppProgressGuide is a "gndrAppProgressGuide" in the app.gndr.actor.defs schema.
//
// If set, an active progress guide. Once completed, can be set to undefined. Should have unspecced fields tracking progress.
type ActorDefs_GndrAppProgressGuide struct {
	Guide string `json:"guide" cborgen:"guide"`
}

// ActorDefs_GndrAppStatePref is a "gndrAppStatePref" in the app.gndr.actor.defs schema.
//
// A grab bag of state that's specific to the gndr.app program. Third-party apps shouldn't use this.
//
// RECORDTYPE: ActorDefs_GndrAppStatePref
type ActorDefs_GndrAppStatePref struct {
	LexiconTypeID       string                          `json:"$type,const=app.gndr.actor.defs#gndrAppStatePref" cborgen:"$type,const=app.gndr.actor.defs#gndrAppStatePref"`
	ActiveProgressGuide *ActorDefs_GndrAppProgressGuide `json:"activeProgressGuide,omitempty" cborgen:"activeProgressGuide,omitempty"`
...
// ActorDefs_ContentLabelPref is a "contentLabelPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_ContentLabelPref
type ActorDefs_ContentLabelPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#contentLabelPref" cborgen:"$type,const=app.gndr.actor.defs#contentLabelPref"`
...
// ActorDefs_FeedViewPref is a "feedViewPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_FeedViewPref
type ActorDefs_FeedViewPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#feedViewPref" cborgen:"$type,const=app.gndr.actor.defs#feedViewPref"`
...
// ActorDefs_HiddenPostsPref is a "hiddenPostsPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_HiddenPostsPref
type ActorDefs_HiddenPostsPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#hiddenPostsPref" cborgen:"$type,const=app.gndr.actor.defs#hiddenPostsPref"`
	// items: A list of URIs of posts the account owner has hidden.
	Items []string `json:"items" cborgen:"items"`
}

// ActorDefs_InterestsPref is a "interestsPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_InterestsPref
type ActorDefs_InterestsPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#interestsPref" cborgen:"$type,const=app.gndr.actor.defs#interestsPref"`
...
// ActorDefs_KnownFollowers is a "knownFollowers" in the app.gndr.actor.defs schema.
//
...
// ActorDefs_LabelerPrefItem is a "labelerPrefItem" in the app.gndr.actor.defs schema.
type ActorDefs_LabelerPrefItem struct {
	Did string `json:"did" cborgen:"did"`
}

// ActorDefs_LabelersPref is a "labelersPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_LabelersPref
type ActorDefs_LabelersPref struct {
	LexiconTypeID string                       `json:"$type,const=app.gndr.actor.defs#labelersPref" cborgen:"$type,const=app.gndr.actor.defs#labelersPref"`
	Labelers      []*ActorDefs_LabelerPrefItem `json:"labelers" cborgen:"labelers"`
}

// ActorDefs_MutedWord is a "mutedWord" in the app.gndr.actor.defs schema.
//
...
// ActorDefs_MutedWordsPref is a "mutedWordsPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_MutedWordsPref
type ActorDefs_MutedWordsPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#mutedWordsPref" cborgen:"$type,const=app.gndr.actor.defs#mutedWordsPref"`
	// items: A list of words the account owner has muted.
	Items []*ActorDefs_MutedWord `json:"items" cborgen:"items"`
}

// ActorDefs_Nux is a "nux" in the app.gndr.actor.defs schema.
//
...
// ActorDefs_PersonalDetailsPref is a "personalDetailsPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_PersonalDetailsPref
type ActorDefs_PersonalDetailsPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#personalDetailsPref" cborgen:"$type,const=app.gndr.actor.defs#personalDetailsPref"`
	// birthDate: The birth date of account owner.
	BirthDate *string `json:"birthDate,omitempty" cborgen:"birthDate,omitempty"`
}

// ActorDefs_PostInteractionSettingsPref is a "postInteractionSettingsPref" in the app.gndr.actor.defs schema.
//
...
type ActorDefs_PostInteractionSettingsPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#postInteractionSettingsPref" cborgen:"$type,const=app.gndr.actor.defs#postInteractionSettingsPref"`
...
func (t *ActorDefs_PostInteractionSettingsPref_PostgateEmbeddingRules_Elem) MarshalJSON() ([]byte, error) {
	if t.FeedPostgate_DisableRule != nil {
		t.FeedPostgate_DisableRule.LexiconTypeID = "app.gndr.feed.postgate#disableRule"
...
func (t *ActorDefs_PostInteractionSettingsPref_PostgateEmbeddingRules_Elem) UnmarshalJSON(b []byte) error {
	...
	switch typ {
	case "app.gndr.feed.postgate#disableRule":
...
func (t *ActorDefs_PostInteractionSettingsPref_ThreadgateAllowRules_Elem) MarshalJSON() ([]byte, error) {
	if t.FeedThreadgate_MentionRule != nil {
		t.FeedThreadgate_MentionRule.LexiconTypeID = "app.gndr.feed.threadgate#mentionRule"
		return json.Marshal(t.FeedThreadgate_MentionRule)
	}
	if t.FeedThreadgate_FollowerRule != nil {
		t.FeedThreadgate_FollowerRule.LexiconTypeID = "app.gndr.feed.threadgate#followerRule"
		return json.Marshal(t.FeedThreadgate_FollowerRule)
	}
	if t.FeedThreadgate_FollowingRule != nil {
		t.FeedThreadgate_FollowingRule.LexiconTypeID = "app.gndr.feed.threadgate#followingRule"
		return json.Marshal(t.FeedThreadgate_FollowingRule)
	}
	if t.FeedThreadgate_ListRule != nil {
		t.FeedThreadgate_ListRule.LexiconTypeID = "app.gndr.feed.threadgate#listRule"
...
type ActorDefs_Preferences_Elem struct {
	...
	ActorDefs_GndrAppStatePref            *ActorDefs_GndrAppStatePref
...
func (t *ActorDefs_Preferences_Elem) MarshalJSON() ([]byte, error) {
	if t.ActorDefs_AdultContentPref != nil {
		t.ActorDefs_AdultContentPref.LexiconTypeID = "app.gndr.actor.defs#adultContentPref"
		return json.Marshal(t.ActorDefs_AdultContentPref)
	}
	if t.ActorDefs_ContentLabelPref != nil {
		t.ActorDefs_ContentLabelPref.LexiconTypeID = "app.gndr.actor.defs#contentLabelPref"
		return json.Marshal(t.ActorDefs_ContentLabelPref)
	}
	if t.ActorDefs_SavedFeedsPref != nil {
		t.ActorDefs_SavedFeedsPref.LexiconTypeID = "app.gndr.actor.defs#savedFeedsPref"
		return json.Marshal(t.ActorDefs_SavedFeedsPref)
	}
	if t.ActorDefs_SavedFeedsPrefV2 != nil {
		t.ActorDefs_SavedFeedsPrefV2.LexiconTypeID = "app.gndr.actor.defs#savedFeedsPrefV2"
		return json.Marshal(t.ActorDefs_SavedFeedsPrefV2)
	}
	if t.ActorDefs_PersonalDetailsPref != nil {
		t.ActorDefs_PersonalDetailsPref.LexiconTypeID = "app.gndr.actor.defs#personalDetailsPref"
		return json.Marshal(t.ActorDefs_PersonalDetailsPref)
	}
	if t.ActorDefs_FeedViewPref != nil {
		t.ActorDefs_FeedViewPref.LexiconTypeID = "app.gndr.actor.defs#feedViewPref"
		return json.Marshal(t.ActorDefs_FeedViewPref)
	}
	if t.ActorDefs_ThreadViewPref != nil {
		t.ActorDefs_ThreadViewPref.LexiconTypeID = "app.gndr.actor.defs#threadViewPref"
		return json.Marshal(t.ActorDefs_ThreadViewPref)
	}
	if t.ActorDefs_InterestsPref != nil {
		t.ActorDefs_InterestsPref.LexiconTypeID = "app.gndr.actor.defs#interestsPref"
		return json.Marshal(t.ActorDefs_InterestsPref)
	}
	if t.ActorDefs_MutedWordsPref != nil {
		t.ActorDefs_MutedWordsPref.LexiconTypeID = "app.gndr.actor.defs#mutedWordsPref"
		return json.Marshal(t.ActorDefs_MutedWordsPref)
	}
	if t.ActorDefs_HiddenPostsPref != nil {
		t.ActorDefs_HiddenPostsPref.LexiconTypeID = "app.gndr.actor.defs#hiddenPostsPref"
		return json.Marshal(t.ActorDefs_HiddenPostsPref)
	}
	if t.ActorDefs_GndrAppStatePref != nil {
		t.ActorDefs_GndrAppStatePref.LexiconTypeID = "app.gndr.actor.defs#gndrAppStatePref"
		return json.Marshal(t.ActorDefs_GndrAppStatePref)
	}
	if t.ActorDefs_LabelersPref != nil {
		t.ActorDefs_LabelersPref.LexiconTypeID = "app.gndr.actor.defs#labelersPref"
		return json.Marshal(t.ActorDefs_LabelersPref)
	}
	if t.ActorDefs_PostInteractionSettingsPref != nil {
		t.ActorDefs_PostInteractionSettingsPref.LexiconTypeID = "app.gndr.actor.defs#postInteractionSettingsPref"
		return json.Marshal(t.ActorDefs_PostInteractionSettingsPref)
	}
	if t.ActorDefs_VerificationPrefs != nil {
		t.ActorDefs_VerificationPrefs.LexiconTypeID = "app.gndr.actor.defs#verificationPrefs"
...
func (t *ActorDefs_Preferences_Elem) UnmarshalJSON(b []byte) error {
	...
	case "app.gndr.actor.defs#verificationPrefs":
...
// ActorDefs_ProfileAssociated is a "profileAssociated" in the app.gndr.actor.defs schema.
...
// ActorDefs_ProfileAssociatedChat is a "profileAssociatedChat" in the app.gndr.actor.defs schema.
type ActorDefs_ProfileAssociatedChat struct {
	AllowIncoming string `json:"allowIncoming" cborgen:"allowIncoming"`
}

// ActorDefs_ProfileView is a "profileView" in the app.gndr.actor.defs schema.
...
// ActorDefs_ProfileViewBasic is a "profileViewBasic" in the app.gndr.actor.defs schema.
...
// ActorDefs_ProfileViewDetailed is a "profileViewDetailed" in the app.gndr.actor.defs schema.
...
// ActorDefs_SavedFeed is a "savedFeed" in the app.gndr.actor.defs schema.
...
// ActorDefs_SavedFeedsPref is a "savedFeedsPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_SavedFeedsPref
type ActorDefs_SavedFeedsPref struct {
	LexiconTypeID string   `json:"$type,const=app.gndr.actor.defs#savedFeedsPref" cborgen:"$type,const=app.gndr.actor.defs#savedFeedsPref"`
...
// ActorDefs_SavedFeedsPrefV2 is a "savedFeedsPrefV2" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_SavedFeedsPrefV2
type ActorDefs_SavedFeedsPrefV2 struct {
	LexiconTypeID string                 `json:"$type,const=app.gndr.actor.defs#savedFeedsPrefV2" cborgen:"$type,const=app.gndr.actor.defs#savedFeedsPrefV2"`
	Items         []*ActorDefs_SavedFeed `json:"items" cborgen:"items"`
}

// ActorDefs_StatusView is a "statusView" in the app.gndr.actor.defs schema.
...
func (t *ActorDefs_StatusView_Embed) MarshalJSON() ([]byte, error) {
	if t.EmbedExternal_View != nil {
		t.EmbedExternal_View.LexiconTypeID = "app.gndr.embed.external#view"
...
func (t *ActorDefs_StatusView_Embed) UnmarshalJSON(b []byte) error {
	...
	switch typ {
	case "app.gndr.embed.external#view":
...
// ActorDefs_ThreadViewPref is a "threadViewPref" in the app.gndr.actor.defs schema.
//
// RECORDTYPE: ActorDefs_ThreadViewPref
type ActorDefs_ThreadViewPref struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#threadViewPref" cborgen:"$type,const=app.gndr.actor.defs#threadViewPref"`
...
// ActorDefs_VerificationPrefs is a "verificationPrefs" in the app.gndr.actor.defs schema.
//
// Preferences for how verified accounts appear in the app.
//
// RECORDTYPE: ActorDefs_VerificationPrefs
type ActorDefs_VerificationPrefs struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.defs#verificationPrefs" cborgen:"$type,const=app.gndr.actor.defs#verificationPrefs"`
...
// ActorDefs_VerificationState is a "verificationState" in the app.gndr.actor.defs schema.
//
...
// ActorDefs_VerificationView is a "verificationView" in the app.gndr.actor.defs schema.
//
...
// ActorDefs_ViewerState is a "viewerState" in the app.gndr.actor.defs schema.
//
