...
func init() {
	util.RegisterType("app.gndr.graph.list", &GraphList{})
} //
// RECORDTYPE: GraphList
type GraphList struct {
	LexiconTypeID     string            `json:"$type,const=app.gndr.graph.list" cborgen:"$type,const=app.gndr.graph.list"`
