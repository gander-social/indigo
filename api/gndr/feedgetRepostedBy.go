...
// schema: app.gndr.feed.getRepostedBy
...
// FeedGetRepostedBy_Output is the output of a app.gndr.feed.getRepostedBy call.
...
// FeedGetRepostedBy calls the XRPC method "app.gndr.feed.getRepostedBy".
//
...
func FeedGetRepostedBy(ctx context.Context, c util.LexClient, cid string, cursor string, limit int64, uri string) (*FeedGetRepostedBy_Output, error) {
	...
	params["uri"] = uri
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getRepostedBy", params, nil, &out); err != nil {
		return nil, err
	}
