...
func init() {
	util.RegisterType("app.gndr.embed.record#main", &EmbedRecord{})
} // EmbedRecord is a "main" in the app.gndr.embed.record schema.
// RECORDTYPE: EmbedRecord
type EmbedRecord struct {
	LexiconTypeID string                         `json:"$type,const=app.gndr.embed.record" cborgen:"$type,const=app.gndr.embed.record"`
	Record        *comatprototypes.RepoStrongRef `json:"record" cborgen:"record"`
}

// EmbedRecord_View is a "view" in the app.gndr.embed.record schema.
//
// RECORDTYPE: EmbedRecord_View
type EmbedRecord_View struct {
	LexiconTypeID string                   `json:"$type,const=app.gndr.embed.record#view" cborgen:"$type,const=app.gndr.embed.record#view"`
	Record        *EmbedRecord_View_Record `json:"record" cborgen:"record"`
}

// EmbedRecord_ViewBlocked is a "viewBlocked" in the app.gndr.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewBlocked
type EmbedRecord_ViewBlocked struct {
	LexiconTypeID string                  `json:"$type,const=app.gndr.embed.record#viewBlocked" cborgen:"$type,const=app.gndr.embed.record#viewBlocked"`
	Author        *FeedDefs_BlockedAuthor `json:"author" cborgen:"author"`
	Blocked       bool                    `json:"blocked" cborgen:"blocked"`
	Uri           string                  `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewDetached is a "viewDetached" in the app.gndr.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewDetached
type EmbedRecord_ViewDetached struct {
	LexiconTypeID string `json:"$type,const=app.gndr.embed.record#viewDetached" cborgen:"$type,const=app.gndr.embed.record#viewDetached"`
	Detached      bool   `json:"detached" cborgen:"detached"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewNotFound is a "viewNotFound" in the app.gndr.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewNotFound
type EmbedRecord_ViewNotFound struct {
	LexiconTypeID string `json:"$type,const=app.gndr.embed.record#viewNotFound" cborgen:"$type,const=app.gndr.embed.record#viewNotFound"`
	NotFound      bool   `json:"notFound" cborgen:"notFound"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// EmbedRecord_ViewRecord is a "viewRecord" in the app.gndr.embed.record schema.
//
// RECORDTYPE: EmbedRecord_ViewRecord
type EmbedRecord_ViewRecord struct {
	LexiconTypeID string                                `json:"$type,const=app.gndr.embed.record#viewRecord" cborgen:"$type,const=app.gndr.embed.record#viewRecord"`
...
func (t *EmbedRecord_View_Record) MarshalJSON() ([]byte, error) {
	if t.EmbedRecord_ViewRecord != nil {
		t.EmbedRecord_ViewRecord.LexiconTypeID = "app.gndr.embed.record#viewRecord"
		return json.Marshal(t.EmbedRecord_ViewRecord)
	}
	if t.EmbedRecord_ViewNotFound != nil {
		t.EmbedRecord_ViewNotFound.LexiconTypeID = "app.gndr.embed.record#viewNotFound"
		return json.Marshal(t.EmbedRecord_ViewNotFound)
	}
	if t.EmbedRecord_ViewBlocked != nil {
		t.EmbedRecord_ViewBlocked.LexiconTypeID = "app.gndr.embed.record#viewBlocked"
		return json.Marshal(t.EmbedRecord_ViewBlocked)
	}
	if t.EmbedRecord_ViewDetached != nil {
		t.EmbedRecord_ViewDetached.LexiconTypeID = "app.gndr.embed.record#viewDetached"
		return json.Marshal(t.EmbedRecord_ViewDetached)
	}
	if t.FeedDefs_GeneratorView != nil {
		t.FeedDefs_GeneratorView.LexiconTypeID = "app.gndr.feed.defs#generatorView"
		return json.Marshal(t.FeedDefs_GeneratorView)
	}
	if t.GraphDefs_ListView != nil {
		t.GraphDefs_ListView.LexiconTypeID = "app.gndr.graph.defs#listView"
	...
	if t.GraphDefs_StarterPackViewBasic != nil {
		t.GraphDefs_StarterPackViewBasic.LexiconTypeID = "app.gndr.graph.defs#starterPackViewBasic"
...
func (t *EmbedRecord_View_Record) UnmarshalJSON(b []byte) error {
	...
	case "app.gndr.graph.defs#starterPackViewBasic":
