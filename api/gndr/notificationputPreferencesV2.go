...
// schema: app.gndr.notification.putPreferencesV2
...
// NotificationPutPreferencesV2_Input is the input argument to a app.gndr.notification.putPreferencesV2 call.
...
// NotificationPutPreferencesV2_Output is the output of a app.gndr.notification.putPreferencesV2 call.
...
// NotificationPutPreferencesV2 calls the XRPC method "app.gndr.notification.putPreferencesV2".
func NotificationPutPreferencesV2(ctx context.Context, c util.LexClient, input *NotificationPutPreferencesV2_Input) (*NotificationPutPreferencesV2_Output, error) {
	...
	if err := c.LexDo(ctx, util.Procedure, "application/json", "app.gndr.notification.putPreferencesV2", nil, input, &out); err != nil {
		return nil, err
	}
