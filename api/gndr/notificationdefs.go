...
// schema: app.gndr.notification.defs
...
// NotificationDefs_FilterablePreference is a "filterablePreference" in the app.gndr.notification.defs schema.
...
// NotificationDefs_Preference is a "preference" in the app.gndr.notification.defs schema.
type NotificationDefs_Preference struct {
	List bool `json:"list" cborgen:"list"`
	Push bool `json:"push" cborgen:"push"`
}

// NotificationDefs_Preferences is a "preferences" in the app.gndr.notification.defs schema.
...
// NotificationDefs_RecordDeleted is a "recordDeleted" in the app.gndr.notification.defs schema.
