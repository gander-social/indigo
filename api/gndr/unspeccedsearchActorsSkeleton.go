...
// schema: app.gndr.unspecced.searchActorsSkeleton
...
// UnspeccedSearchActorsSkeleton_Output is the output of a app.gndr.unspecced.searchActorsSkeleton call.
...
// UnspeccedSearchActorsSkeleton calls the XRPC method "app.gndr.unspecced.searchActorsSkeleton".
//
...
func UnspeccedSearchActorsSkeleton(ctx context.Context, c util.LexClient, cursor string, limit int64, q string, typeahead bool, viewer string) (*UnspeccedSearchActorsSkeleton_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.unspecced.searchActorsSkeleton", params, nil, &out); err != nil {
		return nil, err
	}
