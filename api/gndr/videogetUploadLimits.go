...
// schema: app.gndr.video.getUploadLimits
...
// VideoGetUploadLimits_Output is the output of a app.gndr.video.getUploadLimits call.
...
// VideoGetUploadLimits calls the XRPC method "app.gndr.video.getUploadLimits".
func VideoGetUploadLimits(ctx context.Context, c util.LexClient) (*VideoGetUploadLimits_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.video.getUploadLimits", nil, nil, &out); err != nil {
		return nil, err
	}
