...
func init() {
	util.RegisterType("app.gndr.feed.postgate", &FeedPostgate{})
} //
// RECORDTYPE: FeedPostgate
type FeedPostgate struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.postgate" cborgen:"$type,const=app.gndr.feed.postgate"`
...
// FeedPostgate_DisableRule is a "disableRule" in the app.gndr.feed.postgate schema.
//
// Disables embedding of this post.
//
// RECORDTYPE: FeedPostgate_DisableRule
type FeedPostgate_DisableRule struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.postgate#disableRule" cborgen:"$type,const=app.gndr.feed.postgate#disableRule"`
}
