...
// schema: app.gndr.feed.getFeedGenerator
...
// FeedGetFeedGenerator_Output is the output of a app.gndr.feed.getFeedGenerator call.
...
// FeedGetFeedGenerator calls the XRPC method "app.gndr.feed.getFeedGenerator".
//
...
func FeedGetFeedGenerator(ctx context.Context, c util.LexClient, feed string) (*FeedGetFeedGenerator_Output, error) {
	...
	params["feed"] = feed
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getFeedGenerator", params, nil, &out); err != nil {
		return nil, err
	}
