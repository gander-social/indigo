...
func init() {
	util.RegisterType("app.gndr.actor.status", &ActorStatus{})
} //
// RECORDTYPE: ActorStatus
type ActorStatus struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.status" cborgen:"$type,const=app.gndr.actor.status"`
