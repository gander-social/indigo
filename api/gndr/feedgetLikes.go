...
// FeedGetLikes_Like is a "like" in the app.gndr.feed.getLikes schema.
...
// FeedGetLikes_Output is the output of a app.gndr.feed.getLikes call.
...
// FeedGetLikes calls the XRPC method "app.gndr.feed.getLikes".
//
...
func FeedGetLikes(ctx context.Context, c util.LexClient, cid string, cursor string, limit int64, uri string) (*FeedGetLikes_Output, error) {
	...
	params["uri"] = uri
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getLikes", params, nil, &out); err != nil {
		return nil, err
	}
