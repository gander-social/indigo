...
// schema: app.gndr.graph.getSuggestedFollowsByActor
...
// GraphGetSuggestedFollowsByActor_Output is the output of a app.gndr.graph.getSuggestedFollowsByActor call.
...
// GraphGetSuggestedFollowsByActor calls the XRPC method "app.gndr.graph.getSuggestedFollowsByActor".
func GraphGetSuggestedFollowsByActor(ctx context.Context, c util.LexClient, actor string) (*GraphGetSuggestedFollowsByActor_Output, error) {
	...
	params["actor"] = actor
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.graph.getSuggestedFollowsByActor", params, nil, &out); err != nil {
		return nil, err
	}
