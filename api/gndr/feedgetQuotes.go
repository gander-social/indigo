...
// schema: app.gndr.feed.getQuotes
...
// FeedGetQuotes_Output is the output of a app.gndr.feed.getQuotes call.
...
// FeedGetQuotes calls the XRPC method "app.gndr.feed.getQuotes".
//
...
func FeedGetQuotes(ctx context.Context, c util.LexClient, cid string, cursor string, limit int64, uri string) (*FeedGetQuotes_Output, error) {
	...
	params["uri"] = uri
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getQuotes", params, nil, &out); err != nil {
		return nil, err
	}
