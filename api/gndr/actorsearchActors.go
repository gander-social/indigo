...
// schema: app.gndr.actor.searchActors
...
// ActorSearchActors_Output is the output of a app.gndr.actor.searchActors call.
type ActorSearchActors_Output struct {
	Actors []*ActorDefs_ProfileView `json:"actors" cborgen:"actors"`
	Cursor *string                  `json:"cursor,omitempty" cborgen:"cursor,omitempty"`
}

// ActorSearchActors calls the XRPC method "app.gndr.actor.searchActors".
//
...
func ActorSearchActors(ctx context.Context, c util.LexClient, cursor string, limit int64, q string, term string) (*ActorSearchActors_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.actor.searchActors", params, nil, &out); err != nil {
		return nil, err
	}
