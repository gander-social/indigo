...
// GraphDefs_ListItemView is a "listItemView" in the app.gndr.graph.defs schema.
type GraphDefs_ListItemView struct {
	Subject *ActorDefs_ProfileView `json:"subject" cborgen:"subject"`
	Uri     string                 `json:"uri" cborgen:"uri"`
}

// GraphDefs_ListView is a "listView" in the app.gndr.graph.defs schema.
//
// RECORDTYPE: GraphDefs_ListView
type GraphDefs_ListView struct {
	LexiconTypeID     string                             `json:"$type,const=app.gndr.graph.defs#listView" cborgen:"$type,const=app.gndr.graph.defs#listView"`
...
// GraphDefs_ListViewBasic is a "listViewBasic" in the app.gndr.graph.defs schema.
...
// GraphDefs_ListViewerState is a "listViewerState" in the app.gndr.graph.defs schema.
...
// GraphDefs_NotFoundActor is a "notFoundActor" in the app.gndr.graph.defs schema.
//
// indicates that a handle or DID could not be resolved
//
// RECORDTYPE: GraphDefs_NotFoundActor
type GraphDefs_NotFoundActor struct {
	LexiconTypeID string `json:"$type,const=app.gndr.graph.defs#notFoundActor" cborgen:"$type,const=app.gndr.graph.defs#notFoundActor"`
	Actor         string `json:"actor" cborgen:"actor"`
	NotFound      bool   `json:"notFound" cborgen:"notFound"`
}

// GraphDefs_Relationship is a "relationship" in the app.gndr.graph.defs schema.
//
// lists the bi-directional graph relationships between one actor (not indicated in the object), and the target actors (the DID included in the object)
//
// RECORDTYPE: GraphDefs_Relationship
type GraphDefs_Relationship struct {
	LexiconTypeID string `json:"$type,const=app.gndr.graph.defs#relationship" cborgen:"$type,const=app.gndr.graph.defs#relationship"`
...
// GraphDefs_StarterPackView is a "starterPackView" in the app.gndr.graph.defs schema.
...
// GraphDefs_StarterPackViewBasic is a "starterPackViewBasic" in the app.gndr.graph.defs schema.
//
// RECORDTYPE: GraphDefs_StarterPackViewBasic
type GraphDefs_StarterPackViewBasic struct {
	LexiconTypeID      string                             `json:"$type,const=app.gndr.graph.defs#starterPackViewBasic" cborgen:"$type,const=app.gndr.graph.defs#starterPackViewBasic"`
	Cid                string                             `json:"cid" cborgen:"cid"`
	Creator            *ActorDefs_ProfileViewBasic        `json:"creator" cborgen:"creator"`
	IndexedAt          string                             `json:"indexedAt" cborgen:"indexedAt"`
	JoinedAllTimeCount *int64                             `json:"joinedAllTimeCount,omitempty" cborgen:"joinedAllTimeCount,omitempty"`
