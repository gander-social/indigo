...
// schema: app.gndr.feed.getFeedSkeleton
...
// FeedGetFeedSkeleton_Output is the output of a app.gndr.feed.getFeedSkeleton call.
...
// FeedGetFeedSkeleton calls the XRPC method "app.gndr.feed.getFeedSkeleton".
//
...
func FeedGetFeedSkeleton(ctx context.Context, c util.LexClient, cursor string, feed string, limit int64) (*FeedGetFeedSkeleton_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getFeedSkeleton", params, nil, &out); err != nil {
		return nil, err
	}
