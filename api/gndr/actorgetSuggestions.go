...
// schema: app.gndr.actor.getSuggestions
...
// ActorGetSuggestions_Output is the output of a app.gndr.actor.getSuggestions call.
...
// ActorGetSuggestions calls the XRPC method "app.gndr.actor.getSuggestions".
func ActorGetSuggestions(ctx context.Context, c util.LexClient, cursor string, limit int64) (*ActorGetSuggestions_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.actor.getSuggestions", params, nil, &out); err != nil {
		return nil, err
	}
