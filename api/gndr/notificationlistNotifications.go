...
// schema: app.gndr.notification.listNotifications
...
// NotificationListNotifications_Notification is a "notification" in the app.gndr.notification.listNotifications schema.
...
// NotificationListNotifications_Output is the output of a app.gndr.notification.listNotifications call.
...
// NotificationListNotifications calls the XRPC method "app.gndr.notification.listNotifications".
//
...
func NotificationListNotifications(ctx context.Context, c util.LexClient, cursor string, limit int64, priority bool, reasons []string, seenAt string) (*NotificationListNotifications_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.notification.listNotifications", params, nil, &out); err != nil {
		return nil, err
	}
