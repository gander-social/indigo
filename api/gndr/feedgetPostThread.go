...
// schema: app.gndr.feed.getPostThread
...
// FeedGetPostThread_Output is the output of a app.gndr.feed.getPostThread call.
...
// FeedGetPostThread calls the XRPC method "app.gndr.feed.getPostThread".
//
...
func FeedGetPostThread(ctx context.Context, c util.LexClient, depth int64, parentHeight int64, uri string) (*FeedGetPostThread_Output, error) {
	...
	params["uri"] = uri
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getPostThread", params, nil, &out); err != nil {
		return nil, err
	}
