...
// schema: app.gndr.feed.generator
...
func init() {
	util.RegisterType("app.gndr.feed.generator", &FeedGenerator{})
} //
// RECORDTYPE: FeedGenerator
type FeedGenerator struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.generator" cborgen:"$type,const=app.gndr.feed.generator"`
	// acceptsInteractions: Declaration that a feed accepts feedback interactions from a client through app.gndr.feed.sendInteractions
