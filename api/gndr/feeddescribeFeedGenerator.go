...
// schema: app.gndr.feed.describeFeedGenerator
...
// FeedDescribeFeedGenerator_Feed is a "feed" in the app.gndr.feed.describeFeedGenerator schema.
type FeedDescribeFeedGenerator_Feed struct {
	Uri string `json:"uri" cborgen:"uri"`
}

// FeedDescribeFeedGenerator_Links is a "links" in the app.gndr.feed.describeFeedGenerator schema.
...
// FeedDescribeFeedGenerator_Output is the output of a app.gndr.feed.describeFeedGenerator call.
...
// FeedDescribeFeedGenerator calls the XRPC method "app.gndr.feed.describeFeedGenerator".
func FeedDescribeFeedGenerator(ctx context.Context, c util.LexClient) (*FeedDescribeFeedGenerator_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.describeFeedGenerator", nil, nil, &out); err != nil {
		return nil, err
	}
