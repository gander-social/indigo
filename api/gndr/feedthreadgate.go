...
// schema: app.gndr.feed.threadgate
...
func init() {
	util.RegisterType("app.gndr.feed.threadgate", &FeedThreadgate{})
} //
// RECORDTYPE: FeedThreadgate
type FeedThreadgate struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.threadgate" cborgen:"$type,const=app.gndr.feed.threadgate"`
...
// FeedThreadgate_FollowerRule is a "followerRule" in the app.gndr.feed.threadgate schema.
//
// Allow replies from actors who follow you.
//
// RECORDTYPE: FeedThreadgate_FollowerRule
type FeedThreadgate_FollowerRule struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.threadgate#followerRule" cborgen:"$type,const=app.gndr.feed.threadgate#followerRule"`
}

// FeedThreadgate_FollowingRule is a "followingRule" in the app.gndr.feed.threadgate schema.
//
// Allow replies from actors you follow.
//
// RECORDTYPE: FeedThreadgate_FollowingRule
type FeedThreadgate_FollowingRule struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.threadgate#followingRule" cborgen:"$type,const=app.gndr.feed.threadgate#followingRule"`
}

// FeedThreadgate_ListRule is a "listRule" in the app.gndr.feed.threadgate schema.
//
// Allow replies from actors on a list.
//
// RECORDTYPE: FeedThreadgate_ListRule
type FeedThreadgate_ListRule struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.threadgate#listRule" cborgen:"$type,const=app.gndr.feed.threadgate#listRule"`
	List          string `json:"list" cborgen:"list"`
}

// FeedThreadgate_MentionRule is a "mentionRule" in the app.gndr.feed.threadgate schema.
//
// Allow replies from actors mentioned in your post.
//
// RECORDTYPE: FeedThreadgate_MentionRule
type FeedThreadgate_MentionRule struct {
	LexiconTypeID string `json:"$type,const=app.gndr.feed.threadgate#mentionRule" cborgen:"$type,const=app.gndr.feed.threadgate#mentionRule"`
}
