...
// schema: app.gndr.labeler.service
...
func init() {
	util.RegisterType("app.gndr.labeler.service", &LabelerService{})
} //
// RECORDTYPE: LabelerService
type LabelerService struct {
	LexiconTypeID string                       `json:"$type,const=app.gndr.labeler.service" cborgen:"$type,const=app.gndr.labeler.service"`
