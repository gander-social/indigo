...
// schema: app.gndr.graph.verification
...
func init() {
	util.RegisterType("app.gndr.graph.verification", &GraphVerification{})
} //
// RECORDTYPE: GraphVerification
type GraphVerification struct {
	LexiconTypeID string `json:"$type,const=app.gndr.graph.verification" cborgen:"$type,const=app.gndr.graph.verification"`
