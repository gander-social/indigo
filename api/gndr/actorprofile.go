...
func init() {
	util.RegisterType("app.gndr.actor.profile", &ActorProfile{})
} //
// RECORDTYPE: ActorProfile
type ActorProfile struct {
	LexiconTypeID string `json:"$type,const=app.gndr.actor.profile" cborgen:"$type,const=app.gndr.actor.profile"`
