...
// schema: app.gndr.unspecced.defs

// UnspeccedDefs_SkeletonSearchActor is a "skeletonSearchActor" in the app.gndr.unspecced.defs schema.
type UnspeccedDefs_SkeletonSearchActor struct {
	Did string `json:"did" cborgen:"did"`
}

// UnspeccedDefs_SkeletonSearchPost is a "skeletonSearchPost" in the app.gndr.unspecced.defs schema.
type UnspeccedDefs_SkeletonSearchPost struct {
	Uri string `json:"uri" cborgen:"uri"`
}

// UnspeccedDefs_SkeletonSearchStarterPack is a "skeletonSearchStarterPack" in the app.gndr.unspecced.defs schema.
type UnspeccedDefs_SkeletonSearchStarterPack struct {
	Uri string `json:"uri" cborgen:"uri"`
}

// UnspeccedDefs_SkeletonTrend is a "skeletonTrend" in the app.gndr.unspecced.defs schema.
...
// UnspeccedDefs_TrendView is a "trendView" in the app.gndr.unspecced.defs schema.
...
// UnspeccedDefs_TrendingTopic is a "trendingTopic" in the app.gndr.unspecced.defs schema.
