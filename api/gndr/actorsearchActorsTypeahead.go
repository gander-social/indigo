...
// schema: app.gndr.actor.searchActorsTypeahead
...
// ActorSearchActorsTypeahead_Output is the output of a app.gndr.actor.searchActorsTypeahead call.
type ActorSearchActorsTypeahead_Output struct {
	Actors []*ActorDefs_ProfileViewBasic `json:"actors" cborgen:"actors"`
}

// ActorSearchActorsTypeahead calls the XRPC method "app.gndr.actor.searchActorsTypeahead".
//
...
func ActorSearchActorsTypeahead(ctx context.Context, c util.LexClient, limit int64, q string, term string) (*ActorSearchActorsTypeahead_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.actor.searchActorsTypeahead", params, nil, &out); err != nil {
		return nil, err
	}
