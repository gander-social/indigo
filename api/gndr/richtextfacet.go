...
// schema: app.gndr.richtext.facet
...
// RichtextFacet is a "main" in the app.gndr.richtext.facet schema.
//
...
// RichtextFacet_ByteSlice is a "byteSlice" in the app.gndr.richtext.facet schema.
//
...
func (t *RichtextFacet_Features_Elem) MarshalJSON() ([]byte, error) {
	if t.RichtextFacet_Mention != nil {
		t.RichtextFacet_Mention.LexiconTypeID = "app.gndr.richtext.facet#mention"
		return json.Marshal(t.RichtextFacet_Mention)
	}
	if t.RichtextFacet_Link != nil {
		t.RichtextFacet_Link.LexiconTypeID = "app.gndr.richtext.facet#link"
		return json.Marshal(t.RichtextFacet_Link)
	}
	if t.RichtextFacet_Tag != nil {
		t.RichtextFacet_Tag.LexiconTypeID = "app.gndr.richtext.facet#tag"
...
// RichtextFacet_Link is a "link" in the app.gndr.richtext.facet schema.
//
// Facet feature for a URL. The text URL may have been simplified or truncated, but the facet reference should be a complete URL.
//
// RECORDTYPE: RichtextFacet_Link
type RichtextFacet_Link struct {
	LexiconTypeID string `json:"$type,const=app.gndr.richtext.facet#link" cborgen:"$type,const=app.gndr.richtext.facet#link"`
	Uri           string `json:"uri" cborgen:"uri"`
}

// RichtextFacet_Mention is a "mention" in the app.gndr.richtext.facet schema.
//
// Facet feature for mention of another account. The text is usually a handle, including a '@' prefix, but the facet reference is a DID.
//
// RECORDTYPE: RichtextFacet_Mention
type RichtextFacet_Mention struct {
	LexiconTypeID string `json:"$type,const=app.gndr.richtext.facet#mention" cborgen:"$type,const=app.gndr.richtext.facet#mention"`
	Did           string `json:"did" cborgen:"did"`
}

// RichtextFacet_Tag is a "tag" in the app.gndr.richtext.facet schema.
//
// Facet feature for a hashtag. The text usually includes a '#' prefix, but the facet reference should not (except in the case of 'double hash tags').
//
// RECORDTYPE: RichtextFacet_Tag
type RichtextFacet_Tag struct {
	LexiconTypeID string `json:"$type,const=app.gndr.richtext.facet#tag" cborgen:"$type,const=app.gndr.richtext.facet#tag"`
