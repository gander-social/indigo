...
// schema: app.gndr.unspecced.getTrendingTopics
...
// UnspeccedGetTrendingTopics_Output is the output of a app.gndr.unspecced.getTrendingTopics call.
...
// UnspeccedGetTrendingTopics calls the XRPC method "app.gndr.unspecced.getTrendingTopics".
//
...
func UnspeccedGetTrendingTopics(ctx context.Context, c util.LexClient, limit int64, viewer string) (*UnspeccedGetTrendingTopics_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.unspecced.getTrendingTopics", params, nil, &out); err != nil {
		return nil, err
	}
