...
// schema: app.gndr.unspecced.getSuggestionsSkeleton
...
// UnspeccedGetSuggestionsSkeleton_Output is the output of a app.gndr.unspecced.getSuggestionsSkeleton call.
...
// UnspeccedGetSuggestionsSkeleton calls the XRPC method "app.gndr.unspecced.getSuggestionsSkeleton".
//
...
func UnspeccedGetSuggestionsSkeleton(ctx context.Context, c util.LexClient, cursor string, limit int64, relativeToDid string, viewer string) (*UnspeccedGetSuggestionsSkeleton_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.unspecced.getSuggestionsSkeleton", params, nil, &out); err != nil {
		return nil, err
	}
