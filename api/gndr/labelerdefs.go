...
// schema: app.gndr.labeler.defs

import (
	comatprototypes "github.com/gander-social/gander-indigo-sovereign/api/atproto"
)

// LabelerDefs_LabelerPolicies is a "labelerPolicies" in the app.gndr.labeler.defs schema.
...
// LabelerDefs_LabelerView is a "labelerView" in the app.gndr.labeler.defs schema.
//
// RECORDTYPE: LabelerDefs_LabelerView
type LabelerDefs_LabelerView struct {
	LexiconTypeID string                             `json:"$type,const=app.gndr.labeler.defs#labelerView" cborgen:"$type,const=app.gndr.labeler.defs#labelerView"`
...
// LabelerDefs_LabelerViewDetailed is a "labelerViewDetailed" in the app.gndr.labeler.defs schema.
//
// RECORDTYPE: LabelerDefs_LabelerViewDetailed
type LabelerDefs_LabelerViewDetailed struct {
	LexiconTypeID string                             `json:"$type,const=app.gndr.labeler.defs#labelerViewDetailed" cborgen:"$type,const=app.gndr.labeler.defs#labelerViewDetailed"`
	Cid           string                             `json:"cid" cborgen:"cid"`
	Creator       *ActorDefs_ProfileView             `json:"creator" cborgen:"creator"`
	IndexedAt     string                             `json:"indexedAt" cborgen:"indexedAt"`
	Labels        []*comatprototypes.LabelDefs_Label `json:"labels,omitempty" cborgen:"labels,omitempty"`
...
// LabelerDefs_LabelerViewerState is a "labelerViewerState" in the app.gndr.labeler.defs schema.
