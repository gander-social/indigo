...
func init() {
	util.RegisterType("app.gndr.embed.images#main", &EmbedImages{})
} // EmbedImages is a "main" in the app.gndr.embed.images schema.
// RECORDTYPE: EmbedImages
type EmbedImages struct {
	LexiconTypeID string               `json:"$type,const=app.gndr.embed.images" cborgen:"$type,const=app.gndr.embed.images"`
	Images        []*EmbedImages_Image `json:"images" cborgen:"images"`
}

// EmbedImages_Image is a "image" in the app.gndr.embed.images schema.
...
// EmbedImages_View is a "view" in the app.gndr.embed.images schema.
//
// RECORDTYPE: EmbedImages_View
type EmbedImages_View struct {
	LexiconTypeID string                   `json:"$type,const=app.gndr.embed.images#view" cborgen:"$type,const=app.gndr.embed.images#view"`
	Images        []*EmbedImages_ViewImage `json:"images" cborgen:"images"`
}

// EmbedImages_ViewImage is a "viewImage" in the app.gndr.embed.images schema.
