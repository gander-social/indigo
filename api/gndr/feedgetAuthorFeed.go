...
// schema: app.gndr.feed.getAuthorFeed
...
// FeedGetAuthorFeed_Output is the output of a app.gndr.feed.getAuthorFeed call.
type FeedGetAuthorFeed_Output struct {
	Cursor *string                  `json:"cursor,omitempty" cborgen:"cursor,omitempty"`
	Feed   []*FeedDefs_FeedViewPost `json:"feed" cborgen:"feed"`
}

// FeedGetAuthorFeed calls the XRPC method "app.gndr.feed.getAuthorFeed".
//
...
func FeedGetAuthorFeed(ctx context.Context, c util.LexClient, actor string, cursor string, filter string, includePins bool, limit int64) (*FeedGetAuthorFeed_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.feed.getAuthorFeed", params, nil, &out); err != nil {
		return nil, err
	}
