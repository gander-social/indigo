...
func init() {
	util.RegisterType("app.gndr.embed.video#main", &EmbedVideo{})
} // EmbedVideo is a "main" in the app.gndr.embed.video schema.
// RECORDTYPE: EmbedVideo
type EmbedVideo struct {
	LexiconTypeID string `json:"$type,const=app.gndr.embed.video" cborgen:"$type,const=app.gndr.embed.video"`
...
// EmbedVideo_Caption is a "caption" in the app.gndr.embed.video schema.
type EmbedVideo_Caption struct {
	File *util.LexBlob `json:"file" cborgen:"file"`
	Lang string        `json:"lang" cborgen:"lang"`
}

// EmbedVideo_View is a "view" in the app.gndr.embed.video schema.
//
// RECORDTYPE: EmbedVideo_View
type EmbedVideo_View struct {
	LexiconTypeID string                 `json:"$type,const=app.gndr.embed.video#view" cborgen:"$type,const=app.gndr.embed.video#view"`
	Alt           *string                `json:"alt,omitempty" cborgen:"alt,omitempty"`
	AspectRatio   *EmbedDefs_AspectRatio `json:"aspectRatio,omitempty" cborgen:"aspectRatio,omitempty"`
