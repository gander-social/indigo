...
// schema: app.gndr.graph.getActorStarterPacks
...
// GraphGetActorStarterPacks_Output is the output of a app.gndr.graph.getActorStarterPacks call.
...
// GraphGetActorStarterPacks calls the XRPC method "app.gndr.graph.getActorStarterPacks".
func GraphGetActorStarterPacks(ctx context.Context, c util.LexClient, actor string, cursor string, limit int64) (*GraphGetActorStarterPacks_Output, error) {
	...
	if err := c.LexDo(ctx, util.Query, "", "app.gndr.graph.getActorStarterPacks", params, nil, &out); err != nil {
		return nil, err
	}
