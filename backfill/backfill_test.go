...
func TestBackfill(t *testing.T) {
	...
	opts.NSIDFilter = "app.gndr.feed.follow/"
	...
	for {
		...
		if s.State() == backfill.StateInProgress {
			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindDeleteRecord, "app.gndr.feed.follow/1", nil, &cid.Undef)
			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindDeleteRecord, "app.gndr.feed.follow/2", nil, &cid.Undef)
			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindDeleteRecord, "app.gndr.feed.follow/3", nil, &cid.Undef)
			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindDeleteRecord, "app.gndr.feed.follow/4", nil, &cid.Undef)
			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindDeleteRecord, "app.gndr.feed.follow/5", nil, &cid.Undef)

			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindCreateRecord, "app.gndr.feed.follow/1", nil, &cid.Undef)

			bf.BufferOp(ctx, testRepos[0], repomgr.EvtKindUpdateRecord, "app.gndr.feed.follow/1", nil, &cid.Undef)
