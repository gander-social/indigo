...
```bash
$ goat get at://dril.gndr.social/app.gndr.feed.post/3kkreaz3amd27
{
...
$ goat firehose - app.gndr.feed.post --ops | jq .record.text
[...]

# sample ratio of languages in current posts
$ goat firehose --ops -c app.gndr.feed.post | head -n100 | jq .record.langs[0] -c | sort | uniq -c | sort -nr
     51 "en"
     33 "ja"
      7 null
      3 "pt"
