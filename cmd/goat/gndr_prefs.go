...
var cmdGndrPrefs = &cli.Command{
	...
	Subcommands: []*cli.Command{
		&cli.Command{
			...
			Action: runGndrPrefsExport,
		},
		&cli.Command{
			Name:      "import",
			Usage:     "upload preferences from JSON file",
			ArgsUsage: `<file>`,
			Action:    runGndrPrefsImport,
		},
	},
}

func runGndrPrefsExport(cctx *cli.Context) error {
...
func runGndrPrefsImport(cctx *cli.Context) error {
	ctx := context.Background()
